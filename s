...
int main()
{
    ...
    while(mm>0)
    {
        for(i=0;i<z;i++)if(m[i]==false)
        {
            ...
            if(i==3)
            {
                if(GetAsyncKeyState('S'))  d[1][i]=1;if(GetAsyncKeyState('X'))  d[1][i]=3;
                if(GetAsyncKeyState('Y'))  d[1][i]=4;if(GetAsyncKeyState('C'))  d[1][i]=2;
            }else
            if(i==4)
            {
            ...
            if(s[h[0][i]][h[1][i]]!=0)
            {
                if(s[h[0][i]][h[1][i]]==5)
                {
                    sc[i]++;tp-=1;ret:ax=rand()%(lx-3)+1;ay=rand()%(ly-3)+1;
    ...
    //...................................................................................................................
    FIN:if(sc[0]+sc[1]>hs)hs=sc[0]+sc[1];goto INC;FIN1:return 0;
}
